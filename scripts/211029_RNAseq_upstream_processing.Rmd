...
write.table(trans$counts, file="../data/rnaseq/interim/Trans_Counts_raw.tsv", quote=F, sep="\t", col.names = NA)
write.table(trans$abundance, file="../data/rnaseq/interim/Trans_TPM_raw.tsv", quote=F, sep="\t", col.names = NA)
write.table(trans$length, file="../data/rnaseq/interim/Trans_EffLength_raw.tsv", quote=F, sep="\t", col.names = NA)

write.table(gene$counts, file="../data/rnaseq/interim/Gene_Counts_raw.tsv", quote=F, sep="\t", col.names = NA)
write.table(gene$abundance, file="../data/rnaseq/interim/Gene_TPM_raw.tsv", quote=F, sep="\t", col.names = NA)
write.table(gene$length, file="../data/rnaseq/interim//Gene_EffLength_raw.tsv", quote=F, sep="\t", col.names = NA)


#Export transcript tables
write.table(data.frame(merge(trans.dge$genes, trans.dge$rpkm, by=0), row.names=1), 
            file="../data/rnaseq/processed/Trans_RPKM_MSTR.tsv", quote=F, sep="\t", col.names = NA)
write.table(data.frame(merge(trans.dge$genes, trans.dge$lrpkm, by=0), row.names=1), 
            file="../data/rnaseq/processed/Trans_log2RPKM_MSTR.tsv", quote=F, sep="\t", col.names = NA)


#Export gene tables
write.table(data.frame(merge(annot.gene, gene.dge$cpm, by=0), row.names=1), 
            file="../data/rnaseq/processed/Gene_CPM_MSTR.tsv", quote=F, sep="\t", col.names = NA)
write.table(data.frame(merge(annot.gene, gene.dge$lcpm, by=0), row.names=1), 
            file="../data/rnaseq/processed/Gene_log2CPM_MSTR.tsv", quote=F, sep="\t", col.names = NA)
...
write.table(data.frame(merge(gene.dge.filt$genes, gene.dge.filt$cpm, by = 0), row.names = 1), 
            file=paste0("../data/rnaseq/processed/Gene_filtCPM_MSTR_", exprlvl, "CPM.tsv"), 
...
write.table(data.frame(merge(gene.dge.filt$genes, gene.dge.filt$lcpm, by = 0), row.names = 1), 
            file=paste0("../data/rnaseq/processed/Gene_filtlog2CPM_MSTR_", exprlvl, "CPM.tsv"), 
            quote=F, sep="\t", col.names = NA)
...
```{r}
save.image("../data/rnaseq/processed/Processed_RNAseq.Rdata")
```
