...
load("../data/rnaseq/processed_no11/Processed_RNAseq.Rdata")
```
...
#Export Results
# write.csv(DE$WT_v_KO_sig_cpm, "../data/rnaseq/processed_no11//DEG_WT_v_KO.csv", row.names = TRUE)
# write.csv(DE$P28_v_M12_sig_cpm, "../data/rnaseq/processed_no11/DEG_P28_v_M12_sig.csv", row.names = TRUE)
write.csv(DE$P28_WTvKO_sig_cpm, "../data/rnaseq/processed_no11/DEG_P28_WTvKO.csv", row.names = TRUE)
write.csv(DE$M12_WTvKO_sig_cpm, "../data/rnaseq/processed_no11/DEG_M12_WTvKO.csv", row.names = TRUE)
...
```{r}
save.image(file = "../data/rnaseq/processed_no11/Processed_RNAseq_w_CPM.Rdata")
```
